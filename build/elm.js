...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {R: fragment, T: host, ay: path, X: port_, _: protocol, aa: query};
	});
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{at: $author$project$Main$init, av: $author$project$Main$UrlChanged, aw: $author$project$Main$UrlRequested, aA: $author$project$Main$subscriptions, aC: $author$project$Main$update, aD: $author$project$Main$view});
